 ...
 *  splits PRs into "My PRs" (by repo), individual review requests, and one block
 *  per team; the main pane shows the selected PR's metadata, conversation, and
 *  diff. Data is scoped to the org of the active repo (`useReviews`). */
